...
const RestaurantCard = ({ r }: { r: Restaurant }) => (
  <div className="bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-md transition-shadow border border-gray-100 group">
    <div className="relative h-44 bg-gradient-to-br from-orange-100 to-amber-50 flex items-center justify-center">
      ...
      <span
        className={`absolute top-3 left-3 text-xs font-medium px-2 py-1 rounded-full ${
          r.openNow ? "bg-green-100 text-green-600" : "bg-gray-100 text-gray-500"
        }`}
      >
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-4 mb-8 space-y-4">
          ...
          <div className="flex flex-wrap gap-3 items-center">
            <select
              ...
              className="text-sm border border-gray-200 rounded-xl px-3 py-2 outline-none focus:border-orange-400 text-gray-700 bg-white"
            >
